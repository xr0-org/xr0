...
#[no_mangle]
pub unsafe fn state_static_init(
    mut State: *mut State,
...
#[no_mangle]
pub unsafe fn state_addresses_deallocand(
    mut State: *mut State,
    mut obj: *mut Object,
) -> bool {

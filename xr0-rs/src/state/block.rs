...
extern "C" {
    ...
    fn object_range_create(offset: *mut ast_expr, _: *mut range) -> *mut object;
    fn object_abstractcopy(old: *mut object, s: *mut state) -> *mut object;
    fn object_str(_: *mut object) -> *mut libc::c_char;
    fn object_lower(_: *mut object) -> *mut ast_expr;
    fn object_upper(_: *mut object) -> *mut ast_expr;
    fn object_isdeallocand(_: *mut object, _: *mut state) -> bool;
    fn object_references(_: *mut object, _: *mut location, _: *mut state) -> bool;
    fn object_referencesheap(_: *mut object, _: *mut state) -> bool;
    fn object_isvalue(_: *mut object) -> bool;
    fn object_contig_precedes(
        before: *mut object,
        after: *mut object,
        _: *mut state,
    ) -> bool;
    fn object_upto(
        _: *mut object,
        excl_upper: *mut ast_expr,
        _: *mut state,
    ) -> *mut object;
    fn object_from(
        _: *mut object,
        incl_lower: *mut ast_expr,
        _: *mut state,
    ) -> *mut object;
    fn object_dealloc(_: *mut object, _: *mut state) -> *mut error;
    fn range_create(size: *mut ast_expr, loc: *mut location) -> *mut range;
    fn object_arr_create() -> *mut object_arr;
    fn object_arr_destroy(_: *mut object_arr);
    fn object_arr_copy(_: *mut object_arr) -> *mut object_arr;
    fn object_arr_nobjects(_: *mut object_arr) -> libc::c_int;
    fn object_arr_objects(_: *mut object_arr) -> *mut *mut object;
    fn object_arr_index(
        arr: *mut object_arr,
        offset: *mut ast_expr,
        _: *mut state,
    ) -> libc::c_int;
    fn object_arr_index_upperincl(
        arr: *mut object_arr,
        offset: *mut ast_expr,
        _: *mut state,
    ) -> libc::c_int;
    fn object_arr_insert(
        arr: *mut object_arr,
        index: libc::c_int,
        _: *mut object,
    ) -> libc::c_int;
    fn object_arr_append(arr: *mut object_arr, obj: *mut object) -> libc::c_int;
    fn object_arr_remove(arr: *mut object_arr, index: libc::c_int);
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct error {
...
pub unsafe extern "C" fn block_create() -> *mut block {
    let mut b: *mut block = malloc(::core::mem::size_of::<block>() as libc::c_ulong)
        as *mut block;
...
pub unsafe extern "C" fn block_copy(mut old: *mut block) -> *mut block {
    let mut new: *mut block = malloc(::core::mem::size_of::<block>() as libc::c_ulong)
        as *mut block;
...
pub unsafe extern "C" fn block_install(mut b: *mut block, mut obj: *mut object) {
    if !(object_arr_nobjects((*b).arr) == 0 as libc::c_int) as libc::c_int
        as libc::c_long != 0
    {
        __assert_rtn(
            (*::core::mem::transmute::<
...
pub unsafe extern "C" fn block_observe(
    ...
    if index == -(1 as libc::c_int) {
        ...
        let mut obj: *mut object = object_value_create(
    ...
    let mut observed: *mut object = object_value_create(
        ast_expr_copy(lw),
        state_alloc(s),
    );
...
pub unsafe extern "C" fn block_range_aredeallocands(
    ...
    if !object_isdeallocand(*obj.offset(up_index as isize), s) as libc::c_int
        as libc::c_long != 0
    {
        __assert_rtn(
            (*::core::mem::transmute::<
            ...
            b"block.c\0" as *const u8 as *const libc::c_char,
            187 as libc::c_int,
            b"object_isdeallocand(obj[up_index], s)\0" as *const u8
...
unsafe extern "C" fn hack_first_object_is_exactly_bounds(
    ...
    let mut obj: *mut object = *(object_arr_objects((*b).arr))
...
pub unsafe extern "C" fn block_range_dealloc(
    ...
    if lw_index == -(1 as libc::c_int) {
        return error_create(
            b"lower bound not allocated\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
    }
    let mut up_index: libc::c_int = object_arr_index_upperincl((*b).arr, up, s);
    if up_index == -(1 as libc::c_int) {
        return error_create(
            b"upper bound not allocated\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
    }
    let mut n: libc::c_int = object_arr_nobjects((*b).arr);
...
#[no_mangle]
pub unsafe extern "C" fn block_arr_delete(
    mut arr: *mut block_arr,

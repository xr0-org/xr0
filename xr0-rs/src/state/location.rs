...
pub unsafe extern "C" fn location_create_vconst(
    ...
    let mut loc: *mut location = malloc(
        ::core::mem::size_of::<location>() as libc::c_ulong,
    ) as *mut location;
...
#[no_mangle]
pub unsafe extern "C" fn location_offset(mut loc: *mut location) -> *mut ast_expr {
    return (*loc).offset;
}
#[no_mangle]
...
pub unsafe extern "C" fn location_tostatic(
    ...
    let mut type_equal: bool = (*loc).type_0 as libc::c_uint
        == LOCATION_STATIC as libc::c_int as libc::c_uint;
    let mut b: *mut block = static_memory_getblock(sm, (*loc).block);
    return type_equal as libc::c_int != 0 && !b.is_null();
}
#[no_mangle]
pub unsafe extern "C" fn location_toheap(
    mut loc: *mut location,
    mut h: *mut heap,
) -> bool {
    let mut type_equal: bool = (*loc).type_0 as libc::c_uint
        == LOCATION_DYNAMIC as libc::c_int as libc::c_uint;
    let mut b: *mut block = heap_getblock(h, (*loc).block);
    return type_equal as libc::c_int != 0 && !b.is_null();
}
#[no_mangle]
pub unsafe extern "C" fn location_tostack(
    mut loc: *mut location,
    mut s: *mut stack,
) -> bool {
    let mut type_equal: bool = (*loc).type_0 as libc::c_uint
        == LOCATION_AUTOMATIC as libc::c_int as libc::c_uint;
    let mut b: *mut block = stack_getblock(s, (*loc).block);
    return type_equal as libc::c_int != 0 && !b.is_null();
}
#[no_mangle]
pub unsafe extern "C" fn location_toclump(
    mut loc: *mut location,
    mut c: *mut clump,
) -> bool {
    let mut type_equal: bool = (*loc).type_0 as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn location_equal(
    mut l1: *mut location,
    mut l2: *mut location,
) -> bool {
...
pub unsafe extern "C" fn location_isauto(mut loc: *mut location) -> bool {
    return (*loc).type_0 as libc::c_uint
        == LOCATION_AUTOMATIC as libc::c_int as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn location_referencesheap(
    mut l: *mut location,
    mut s: *mut state,
) -> bool {
...
pub unsafe extern "C" fn location_getstackblock(
    ...
    if !((*loc).type_0 as libc::c_uint
        == LOCATION_AUTOMATIC as libc::c_int as libc::c_uint) as libc::c_int
        as libc::c_long != 0
    {
        __assert_rtn(
            (*::core::mem::transmute::<
...
pub unsafe extern "C" fn location_dealloc(
    ...
    if (*loc).type_0 as libc::c_uint != LOCATION_DYNAMIC as libc::c_int as libc::c_uint {
        return error_create(
            b"not heap location\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
    }
...
pub unsafe extern "C" fn location_range_dealloc(
    ...
    if b.is_null() {
        return error_create(
            b"cannot get block\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
    }
    if !block_range_aredeallocands(b, lw, up, state) {
        printf(b"block: %s\n\0" as *const u8 as *const libc::c_char, block_str(b));
        printf(
        ...
        return error_create(
            b"some values not allocated\0" as *const u8 as *const libc::c_char
                as *mut libc::c_char,
        );
    }

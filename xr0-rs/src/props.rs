...
extern "C" {
    ...
    fn ast_expr_inverted_copy(expr: *mut ast_expr, invert: bool) -> *mut ast_expr;
...
#[no_mangle]
pub unsafe extern "C" fn props_props(mut p: *mut props) -> *mut *mut ast_expr {
    return (*p).prop;
}
#[no_mangle]
pub unsafe extern "C" fn props_install(mut p: *mut props, mut e: *mut ast_expr) {
...
#[no_mangle]
pub unsafe extern "C" fn props_get(mut p: *mut props, mut e: *mut ast_expr) -> bool {
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < (*p).n {
...
#[no_mangle]
pub unsafe extern "C" fn props_contradicts(
    mut p: *mut props,
    mut p1: *mut ast_expr,
) -> bool {
...
unsafe extern "C" fn props_contradicts_actual(
    ...
    while i < (*p).n {
        ...
        let mut not_p2: *mut ast_expr = ast_expr_inverted_copy(
            p2,
            1 as libc::c_int != 0,
        );
